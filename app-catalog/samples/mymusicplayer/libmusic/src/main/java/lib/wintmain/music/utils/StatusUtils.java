...
public class StatusUtils {
     ...
     *
     * @param color        Status color.
     * @param surfaceColor Between 21 and 23,if surfaceColor == {@link #USE_DEFAULT_COLOR},the
     *                     status color is defaultColor_21,
     *                     else if surfaceColor == {@link #USE_CUR_COLOR}, the status color is
     *                     color,
    ...
    public static void setUseStatusBarColor(Activity activity, @ColorInt int color,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            activity.getWindow().setStatusBarColor(
                    (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M || (surfaceColor
                            == USE_CUR_COLOR)) ? color
                            : surfaceColor == USE_DEFAULT_COLOR ? defaultColor_21 : surfaceColor);
        }
    }
    ...
    public static void setSystemStatus(Activity activity, boolean isTransparent, boolean isBlack) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
            ...
            ViewGroup contentView = (ViewGroup) activity.getWindow().findViewById(
