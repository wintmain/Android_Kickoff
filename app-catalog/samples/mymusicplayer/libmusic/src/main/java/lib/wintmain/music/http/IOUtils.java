...
package lib.wintmain.music.http;
...
public class IOUtils {
    ...
    public static BufferedWriter toBufferedWriter(Writer writer) {
        return writer instanceof BufferedWriter ? (BufferedWriter) writer : new BufferedWriter(
                writer);
    }
    ...
    public static long getDirSize(String path) {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            return getStatFsSize(stat, "getBlockSizeLong",
    ...
    private static long getStatFsSize(StatFs statFs, String blockSizeMethod,
            String availableBlocksMethod) {
        try {
